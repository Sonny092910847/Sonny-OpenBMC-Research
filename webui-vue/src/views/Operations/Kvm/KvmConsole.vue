        ...
        <b-col class="d-flex justify-content-end pr-1">
          ...
          >
            <template #button-content>
              <icon-power />
              {{ $t('pageKvm.serverPowerOperations') }}
            </template>
            <b-dropdown-item
            ...
            <b-dropdown-item @click="rebootServer('orderly')">
              {{ $t('pageServerPowerOperations.gracefulRestart') }}
            </b-dropdown-item>
            <b-dropdown-item @click="rebootServer('immediate')">
              {{ $t('pageServerPowerOperations.forceRestart') }}
            </b-dropdown-item>
            <b-dropdown-divider></b-dropdown-divider>
            <b-dropdown-item @click="shutdownServer('orderly')">
              {{ $t('pageServerPowerOperations.gracefulShutdown') }}
            </b-dropdown-item>
            <b-dropdown-item @click="shutdownServer('immediate')">
